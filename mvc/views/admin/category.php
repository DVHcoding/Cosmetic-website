                ...
                <div class="activity-grid">
                    <div class="activity-card">
                                    ...
                                    foreach ($data['categoryList'] as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($value['status']) { ?>
                                                    <a class="button-red"
                                                        href="<?= URL_ROOT . '/categoryManage/changeStatus/' . $value['id'] ?>">Khóa</a>
                                                <?php } else { ?>
                                                    <a class="button-green"
                                                        href="<?= URL_ROOT . '/categoryManage/changeStatus/' . $value['id'] ?>">Mở</a>
                                                <?php }
                                                ?>
                                                </a>
                                                <a class="button-normal"
                                                    href="<?= URL_ROOT . '/categoryManage/edit/' . $value['id'] ?>">Sửa</a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
                        ...
                        <div class="pagination">
                            <a
                                href="<?= URL_ROOT ?>/categoryManage?page=<?= (isset($_GET['page'])) ? (($_GET['page'] <= 1) ? 1 : $_GET['page'] - 1) : 1 ?>">&laquo;</a>
                            <?php
                            ...
                            ?>
                            <a
                                href="<?= URL_ROOT ?>/categoryManage?page=<?= (isset($_GET['page'])) ? ($_GET['page'] == $data['countPaging'] ? $_GET['page'] : $_GET['page'] + 1) : 2 ?>">&raquo;</a>
                        </div>
                    </div>
                </div>
            </section>
